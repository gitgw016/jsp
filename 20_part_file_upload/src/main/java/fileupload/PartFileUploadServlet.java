...
//@WebServlet("/result")
//@MultipartConfig(fileSizeThreshold = 1024*1024*10, maxFileSize = -1, maxRequestSize = -1)
public class PartFileUploadServlet extends HttpServlet {
	...
	private String getFileName(String original) {
		// ss : 초 / SS : 1000 1초 단위 아래의 값을 000~999 까지 표현
