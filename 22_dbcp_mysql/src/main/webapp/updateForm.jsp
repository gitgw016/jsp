...
<%
	...
	if(num == null || num.trim().equals("")){
		out.print("<script>alert('여기 왜왔냐? 돌아가라.');history.go(-1)</script>");
		return;
	}
...
<body>
	<form action="updateSubmit.jsp" method="post">
		...
		<table>
			...
			<tr>
				<td>내용</td>
				<td><textarea name="board_content" style="resize:none;" rows="20" cols="50"><%=content%></textarea></td>
			</tr>
			<tr>
