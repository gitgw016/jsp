...
<c:if test="${!empty cookie.u_id and empty sessionScope.member}">
	MyCookie : 쿠기 name : ${cookie.u_id}<br/>
	MyCookie : 쿠기 name : ${cookie.u_id.name}<br/>
	MyCookie : 쿠기 value : ${cookie.u_id.value}<br/>
	MyCookie : 쿠기 value : ${cookie['u_id']['value']}<br/>
			...
			<ul>
				...
				<c:choose>
					<c:when test="${!empty sessionScope.member}">
						<li><a href="main.jsp?page=info">${member.u_id}</a> 왔냐</li>
